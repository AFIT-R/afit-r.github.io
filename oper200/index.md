...
|:---:|---|:---:|
| 1 | Introduction & Getting started with R  | <a href="oper200/introduction" style="color:black;"><i class="fa fa-file-powerpoint-o" aria-hidden="true"></i></a> &nbsp; <a href="bootcamp/introduction/1-intro-students.R" style="color:black;"><i class="fa fa-file-code-o" aria-hidden="true"></i></a> |
